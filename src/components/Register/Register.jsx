      ...
      <div className="col-12 col-lg-10 col-xl-8">
        <div className="row gy-5 justify-content-center">
              ...
              <div className="row gy-3 overflow-hidden">
                ...
                {/* <div className="col-12">
                  <div className="form-check">
                    <input onChange={formik.handleChange} onBlur={formik.handleBlur}  className="form-check-input" type="checkbox" defaultValue name="iAgree" id="iAgree" required />
                    <label className="form-check-label text-secondary" htmlFor="iAgree">
                      I agree to the <Link to={"/termsAndConditions"} className="link-primary text-decoration-none">terms and conditions</Link>
                    </label>
                  </div>
                </div> */}
                <div className="col-12">
          ...
          <div className="col-12 col-lg-2 d-flex align-items-center justify-content-center gap-3 flex-lg-column">
            <div className="bg-dark h-100 d-none d-lg-block" style={{width: 1, '--bs-bg-opacity': '.1'}} />
            <div className="bg-dark w-100 d-lg-none" style={{height: 1, '--bs-bg-opacity': '.1'}} />
            <div>or</div>
            <div className="bg-dark h-100 d-none d-lg-block" style={{width: 1, '--bs-bg-opacity': '.1'}} />
            <div className="bg-dark w-100 d-lg-none" style={{height: 1, '--bs-bg-opacity': '.1'}} />
          </div>
