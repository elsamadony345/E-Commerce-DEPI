...
<footer className="footer">
  ...
  <section>
    <div className="container-fluid">
      <div className="row">
        <div className="col-12 col-lg-4 bg-primary py-4 py-md-5 py-xxl-8">
          <div className="row h-100 align-items-end justify-content-center">
            <div className="col-12 col-md-11 col-xl-10">
              <div className="footer-logo-wrapper">
                <a href="#!">
                  <img src="./assets/img/bsb-logo-light.svg" alt="BootstrapBrain Logo" width={179} height={60} />
                </a>
              </div>
              <div className="social-media-wrapper mt-5">
                <ul className="nav">
                  <li className="nav-item me-3">
                    <a className="nav-link link-primary p-2 bg-light rounded" href="#!">
              ...
              <div className="address-wrapper mt-5">
                <address className="mb-2 text-white">8014 Edith Blvd NE, Albuquerque, New York, United States</address>
                <p className="mb-2">
                  <a className="link-light text-decoration-none" href="tel:+15057922430">(505) 792-2430</a>
                </p>
                <p className="mb-0">
                  <a className="link-light text-decoration-none" href="mailto:demo@yourdomain.com">demo@yourdomain.com</a>
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="col-6 col-sm-3">
                  <div className="widget">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="mb-3">
                        <a href="#!" className="link-secondary text-decoration-none">Video Animations</a>
                      </li>
                      <li className="mb-0">
                        <a href="#!" className="link-secondary text-decoration-none">Logo Design</a>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="col-6 col-sm-3">
                  <div className="widget">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="mb-3">
                        <a href="#!" className="link-secondary text-decoration-none">Events</a>
                      </li>
                      <li className="mb-3">
                        <a href="#!" className="link-secondary text-decoration-none">Careers</a>
                      </li>
                      <li className="mb-3">
